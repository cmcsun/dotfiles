...
user_pref("social.toast-notifications.enabled", true);
...
user_pref("dom.webnotifications.enabled", true); // https://developer.mozilla.org/en-US/docs/Web/API/notification
user_pref("dom.webnotifications.serviceworker.enabled", true); // https://developer.mozilla.org/en-US/docs/Web/API/notification
